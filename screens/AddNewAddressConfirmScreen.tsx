        ...
        >
          ...
          <View style={styles.sectionContainer}>
            ...
            <View style={styles.addressCard}>
              <Text style={styles.addressText}>Sky Avenue, Street 5, House 14, DHA Phase 2</Text>
              <TouchableOpacity style={styles.addOtherAddressButton}>
                <Text style={styles.addOtherAddressText}>Add Other Address</Text>
              </TouchableOpacity>
            </View>
          </View>
            ...
            {savedCard && paymentMethod === 'card' && (
              <View style={styles.savedCardInfo}>
                ...
                <Text style={styles.savedCardText}>
                  {savedCard.paymentMethod} •••• {savedCard.cardNumber.slice(-4)}
                </Text>
              </View>
            )}
          ...
          <View style={styles.sectionContainer}>
            ...
            <View style={styles.orderSummaryCard}>
              ...
              <View style={styles.totalAmountRow}>
                ...
                <Text style={styles.totalAmountValue}>Rs.{finalAmountCalc}</Text>
              </View>
            </View>
          </View>
