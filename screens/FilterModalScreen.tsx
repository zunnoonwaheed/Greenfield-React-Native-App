...
const FilterModalScreen: React.FC = () => {
  ...
  const handleApplyFilters = () => {
    // Navigate to filter modal with selections
    setModalVisible(false);
    navigation.navigate('FilterModalWithSelections');
  };
            ...
            <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
              <View style={styles.filterContent}>
                ...
                <View style={styles.filterSection}>
                  ...
                  {renderInputField(
                    renderSortIcon(),
                    'e.g. Price (Low to High / High to Low)',
                    true
                  )}
                </View>
