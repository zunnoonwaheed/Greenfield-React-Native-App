...
type ParamsForScreen<T> = T extends {
    screen: infer Screen;
} ? Screen extends StaticNavigationConfig ? NavigatorScreenParams<StaticParamList<Screen>> | undefined : UnknownToUndefined<ParamsForScreenComponent<T>> : T extends StaticNavigationConfig ? NavigatorScreenParams<StaticParamList<T>> | undefined : UnknownToUndefined<ParamsForScreenComponent<T>>;
 ...
 */
export type StaticParamList<T extends StaticNavigationConfig> = FlatType<ParamListForScreens<T['config']['screens']> & ParamListForGroups<T['config']['groups']>>;
type ParamListForStaticNavigator<T> = T extends StaticNavigationConfig ? StaticParamList<T> : {};
type ParamListForTypedNavigator<T> = T extends {
    Screen: any;
} & PrivateValueStore<infer Value> ? Value[0] : {};
type ParamListForRootNavigator<T> = string extends keyof ParamListForTypedNavigator<T> ? ParamListForStaticNavigator<T> : ParamListForTypedNavigator<T>;
/**
...
type TypedNavigatorComponent<Bag extends NavigatorTypeBagBase> = React.ComponentType<Omit<React.ComponentProps<TypedNavigatorInternal<Bag['ParamList'], Bag['NavigatorID'], Bag['State'], Bag['ScreenOptions'], Bag['EventMap'], Bag['NavigationList'], Bag['Navigator']>['Navigator']>, 'children'>>;
type TypedNavigatorStaticDecorated<Bag extends NavigatorTypeBagBase, Config> = TypedNavigatorInternal<Bag['ParamList'], Bag['NavigatorID'], Bag['State'], Bag['ScreenOptions'], Bag['EventMap'], Bag['NavigationList'], Bag['Navigator']> & {
    getComponent: () => React.ComponentType<{}>;
    config: Config;
} & PrivateValueStore<[Bag['ParamList'], Bag['NavigationList'], unknown]>;
type TypedNavigatorStatic<Bag extends NavigatorTypeBagBase, Config> = TypedNavigatorInternal<Bag['ParamList'], Bag['NavigatorID'], Bag['State'], Bag['ScreenOptions'], Bag['EventMap'], Bag['NavigationList'], Bag['Navigator']> & {
    config: Config;
...
export type TypedNavigator<Bag extends NavigatorTypeBagBase, Config = unknown> = (undefined extends Config ? TypedNavigatorInternal<Bag['ParamList'], Bag['NavigatorID'], Bag['State'], Bag['ScreenOptions'], Bag['EventMap'], Bag['NavigationList'], Bag['Navigator']> : TypedNavigatorStatic<Bag, Config>) & PrivateValueStore<[Bag['ParamList'], Bag['NavigationList'], unknown]>;
