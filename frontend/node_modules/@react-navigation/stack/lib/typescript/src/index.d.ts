 ...
 * Types
 */
export type { StackAnimationName, StackCardInterpolatedStyle, StackCardInterpolationProps, StackCardStyleInterpolator, StackHeaderInterpolatedStyle, StackHeaderInterpolationProps, StackHeaderLeftProps, StackHeaderProps, StackHeaderRightProps, StackHeaderStyleInterpolator, StackNavigationEventMap, StackNavigationOptions, StackNavigationProp, StackNavigatorProps, StackOptionsArgs, StackScreenProps, TransitionPreset, } from './types';
