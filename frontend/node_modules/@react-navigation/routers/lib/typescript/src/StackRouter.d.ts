import type { DefaultRouterOptions, NavigationRoute, NavigationState, ParamListBase, Router } from './types.js';
...
export declare function StackRouter(options: StackRouterOptions): Router<StackNavigationState<ParamListBase>, import("./CommonActions.js").Action | StackActionType>;
