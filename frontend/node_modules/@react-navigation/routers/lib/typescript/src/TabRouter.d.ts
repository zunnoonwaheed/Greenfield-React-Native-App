import type { DefaultRouterOptions, NavigationState, ParamListBase, Router } from './types.js';
...
export declare function TabRouter({ initialRouteName, backBehavior, }: TabRouterOptions): Router<TabNavigationState<ParamListBase>, import("./CommonActions.js").Action | TabActionType>;
