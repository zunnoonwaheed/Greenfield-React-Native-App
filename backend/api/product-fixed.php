<?php
/**
 * Get Product Details API - FIXED VERSION
...
// Get similar products (same category) - FIXED: removed non-existent columns
...
// Get frequently bought together (popular products from different categories) - FIXED
...
// Get other recommendations (recently added products) - FIXED
...
echo json_encode([
    ...
    'data' => [
        'product' => [
            ...
            'discounted_price' => (float)($product['dprice'] ?: $product['price']),
