...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            echo $controls->getHeaderSection('Insert Manager & Writer');//.$_GET['role']);
            ?>
                    ...
                    <div class="col-lg-12">
                        <div class="tabs-container">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#tab-1"> Insert Manager & Writer <?php //echo $_GET['role']; ?></a></li>
                            </ul>
                            <form action="prInserted.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Role</label>
                                    <div class="col-sm-10">
                                        <select name="writer_asign" class="form-control">
                                ...
                                <input name="Submit"  type="submit" class="btn btn-block btn-outline btn-success" value="Submit <?php //echo $_GET['role'];?>" style="width: 15%;  margin: auto;" /></form>
                            </fieldset>
                        </div>
                    </div>
                </div>
