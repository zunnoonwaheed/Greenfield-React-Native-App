                                    ...
                                    <tr height="480">
                                        ...
                                        <td valign="top">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td height="25" colspan="4" bgcolor="#F0F8FF" class="Heading6">Update Image</td>
                                                </tr>
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td colspan="4" valign="top"><form action="brandUpdated1.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>&nbsp;</td>
                                                                    <td><input name="Submit" type="submit" class="text6" id="Submit" value="Update Image" />
