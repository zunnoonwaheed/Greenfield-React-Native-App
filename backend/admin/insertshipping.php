                                    ...
                                    <tr height="480">
                                        ...
                                        <td valign="top">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td height="25" colspan="4" bgcolor="#F0F8FF" class="Heading6">Insert Shipping</td>
                                                </tr>
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td colspan="4" valign="top"><form action="shippingInserted.php" method="post" enctype="multipart/form-data" name="form1" id="form1">

                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td width="16%" align="left" class="text7">Country</td>
                                                                    <td width="84%"><select name="title" class="twelve" id="title" style="width:200px;">
                                                                            <option value="None" selected="selected">Country</option>
                                                                ...
                                                                <tr>
                                                                    <td class="text7">Rate</td>
                                                                    <td><label for=""></label>
                                                                        <input name="rate" type="text" class="text7" id="rate" size="40" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                    <td>&nbsp;</td>
