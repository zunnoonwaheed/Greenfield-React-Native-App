										...
										<td valign="top">
												<table width="100%" border="0" cellpadding="0" cellspacing="0">
												  <tr height="20">
													...
													<span class="heading">Insert Text Pages</span> </td>
				  </tr>
						  <tr>
							<td><table width="100%" border="1" cellpadding="5">
                              <tr>
                                <td><form id="form2" name="form2" method="post" action="tpInserted.php">
                                  ...
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      ...
                                      <input name="namee" type="text" id="namee" size="35" /></td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td>&nbsp;</td>
                                    ...
                                    <tr>
                                      ...
                                      <td><textarea name="pageData" cols="90" rows="20"></textarea></td>
                                    </tr>
                                    <tr>
                                      <td colspan="2">&nbsp;</td>
                                      </tr>
                                      ...
                                      <td colspan="2"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                          ...
                                          <td width="80%"><label for="title"></label>
                                            <input name="title" type="text" class="text6" id="title" size="60" /></td>
                                        </tr>
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td>&nbsp;</td>
                                        ...
                                        <tr>
                                          ...
                                          <td><label for="keyword"></label>
                                            <textarea name="keyword" cols="65" rows="5" class="text6" id="keyword"></textarea></td>
                                        </tr>
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td>&nbsp;</td>
                                        ...
                                        <tr>
                                          ...
                                          <td><label for="descr"></label>
                                            <textarea name="descr" cols="65" rows="5" class="text6" id="descr"></textarea></td>
                                        </tr>
                                      </table></td>
                                    </tr>
                                    <tr>
