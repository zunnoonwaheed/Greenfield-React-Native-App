                                    ...
                                    <tr height="480">
                                        ...
                                        <td valign="top">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td height="25" colspan="4" bgcolor="#F0F8FF" class="Heading6">Edit Color</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="4"><form action="colorUpdated.php" method="post" enctype="multipart/form-data" name="form1" id="form1">

                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td width="13%" align="left" class="text7">Name</td>
                                                                    <td width="87%"><label for="namee2"></label>
                                                                        <input name="name" type="text" class="text7" id="name" size="40" value="<?php echo $row['name'];?>" /></td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td align="left" class="text7">Image</td>
                                                                    <td align="left"><label for="file1"></label>
                                                                ...
                                                                <tr>
                                                                    <td align="left" class="text7">Description</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="left"><input type="hidden" name="id" id="id" value="<?php echo $id; ?>" />
                                                                        <input type="hidden" name="imgName" id="imgName" value="<?php echo $imgName; ?>" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;</td>
