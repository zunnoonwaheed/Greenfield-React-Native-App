...
for ($i=0; $i < mysqli_num_rows ($resulti); $i++){
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="5%" align="center" ><input type="checkbox" name="rp3[]" id="rp3[]"  value="<?php echo $query_data2['id'];?>"/>
            ...
            if ($i <mysqli_num_rows ($resulti)){
                ...
                <td width="5%" align="center" ><input type="checkbox" name="rp3[]" id="rp3[]"  value="<?php echo $query_data2['id'];?>"/></td>
