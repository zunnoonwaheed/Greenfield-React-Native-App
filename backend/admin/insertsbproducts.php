                                    ...
                                    <tr height="480">
                                        ...
                                        <td valign="top">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td height="25" colspan="4" bgcolor="#F0F8FF" class="Heading6">Insert <?php echo  $row_cat['namee'];?></td>
                                                </tr>
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td colspan="4"><form action="sbproductsInserted.php" method="post" name="form1" id="form1">
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
                                                                ...
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                    <td><input type="hidden" name="catID" id="catID" value="<?php echo $catID; ?>" /><input type="hidden" name="mainID" id="mainID" value="<?php echo $mainID; ?>" /></td>
                                                                </tr>
                                                                <tr>
