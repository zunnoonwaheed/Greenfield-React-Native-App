                          ...
                          <tr height="480">
                            ...
                            <td valign="top">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
								  <tr>
								    <td height="25" colspan="4" bgcolor="#F0F8FF" class="Heading6">Insert Category</td>
							      </tr>
								  <tr>
								    <td>&nbsp;</td>
								    <td>&nbsp;</td>
								  ...
								  <tr>
								    <td colspan="4" valign="top"><form action="mrInserted.php" method="post" name="form1" id="form1">
								    
								      <table width="100%" border="0" cellspacing="0" cellpadding="0">
								        <tr>
								          <td width="18%" align="left" class="text7">Name</td>
								          <td width="82%"><label for="namee"></label>
