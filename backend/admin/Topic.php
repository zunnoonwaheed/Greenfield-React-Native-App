                                    ...
                                    <tr height="480">
                                        ...
                                        <td valign="top">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td height="25" colspan="2" bgcolor="#F0F8FF" class="Heading6"><?php echo $rec_found_c['title'];?></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td height="13" colspan="2" align="left"><div align="center"><a href="insertproducts.php?catID=<?php echo $catID;?>">INSERT <?php echo $rec_found_c['title'];?></a></div></td>
                                                </tr>
                                                    ...
                                                    <td width="25%" height="13" align="left"><table width="98%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            if($rec_found >0){
                                                                while($row = mysqli_fetch_array($result)){;
                                                                    ...
                                                                    <tr>
                                                                        <td width="37%" align="center" valign="top" class="text6"><?php echo $row['namee'];?></td>
                                                                        <?php /*?><td width="30%" align="center" valign="top" class="text6"><span class="Heading5"><?php echo $row['price'];?></span></td><?php */?>
                                                                        <td width="33%" align="center" valign="top"><a href="editproducts.php?id=<?php echo $row['id'];?>&catID=<?php echo $row['catID'];?>">EDIT</a> - <a href="delProducts.php?id=<?php echo $row['id'];?>&catID=<?php echo $row['catID'];?>" onClick="return confirm('ALERT! \nAre you sure you want to delete')">DELETE</a> - <a href="subProducts.php?catID=<?php echo $row['id'];?>">Sub Products</a></td>
                                                                    </tr>
                                                                    <tr>
