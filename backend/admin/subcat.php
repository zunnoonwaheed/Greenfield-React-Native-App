                                    ...
                                    <tr height="480">
                                        ...
                                        <td valign="top">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td height="25" colspan="4" bgcolor="#F0F8FF" class="Heading6">Insert Sub Category</td>
                                                </tr>
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td colspan="4" valign="top"><form action="subcatInserted.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    $catID=$_REQUEST['id'];
                                                                    ?>
                                                                    <td><input type="hidden" name="catID" id="catID" value="<?php echo $catID; ?>" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="text7">Insert Image</td>
                                                                    <td><input name="file1" type="file" class="text6" id="file1" size="35" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                    <td>&nbsp;</td>
