                                    ...
                                    <tr height="480">
                                        ...
                                        <td valign="top">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td height="25" colspan="4" bgcolor="#F0F8FF" class="Heading6">Insert Website</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td colspan="4"><form action="videoInserted.php" method="post" enctype="multipart/form-data" name="form1" id="form1">

                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td width="16%" align="left" class="text7">Title</td>
                                                                    <td width="84%" align="left"><label for="namee"></label>
                                                                        <input name="namee" type="text" class="text6" id="namee" size="50" /></td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td align="left" class="text7">Logo</td>
                                                                    <td align="left" class="text4"><label for="fileField"></label>
