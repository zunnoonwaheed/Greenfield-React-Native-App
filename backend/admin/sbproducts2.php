...
$query_c = "select * from products where id=$catID";
                          ...
                          <tr height="480">
                            ...
                            <td valign="top">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
								  ...
								  <tr>
								    <td height="13" colspan="2" align="left"><div align="center"><a href="insertsbproducts2.php?catID=<?php echo $catID; ?>">INSERT <?php echo $rec_found_c['namee'];?></a></div></td>
							      </tr>
		...
		?>
								      ...
								      <tr>
								        <td width="37%" align="center" valign="top" class="text6"><?php echo $row['namee'];?></td>
                                        							        <td width="30%" align="center" valign="top" class="text6"><?php echo $row['price'];?></td>
                                        <td width="33%" align="center" valign="top"><a href="editsbproducts2.php?id=<?php echo $row['id'];?>&catID=<?php echo $row['catID'];?>">EDIT</a> - <a href="delsbProducts2.php?id=<?php echo $row['id'];?>&catID=<?php echo $row['catID'];?>" onClick="return confirm('ALERT! \nAre you sure you want to delete this category\nand all of its item')">DELETE</a></td>
							          </tr>
								      <tr>
