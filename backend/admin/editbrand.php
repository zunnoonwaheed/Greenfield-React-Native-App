                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="tabs-container">
                            ...
                            <form action="brandUpdated.php" method="post" enctype="multipart/form-data">
    ...
    <div class="col-sm-10">
        <select name="mainID" id="mainID" class="form-control">
            ...
            while($cat = mysqli_fetch_assoc($catRes)){
                $selected = ($cat['id'] == $row['mainID']) ? "selected" : "";
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <?php if(!empty($row['image'])) { ?>
                <img src="upload/brands/<?php echo $row['image']; ?>" alt="Image" style="max-width:150px; margin-bottom:10px;">
            <?php } ?>
