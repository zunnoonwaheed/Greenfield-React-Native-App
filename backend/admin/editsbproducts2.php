                                    ...
                                    <tr height="480">
                                        ...
                                        <td valign="top">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td height="25" colspan="4" bgcolor="#F0F8FF" class="Heading6">Edit Products</td>
                                                </tr>
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td colspan="4" valign="top"><form action="sbproducts2Updated.php" method="post" name="form1" id="form1">
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><input name="price" type="text" class="text7" id="price" size="40" value="<?php echo $row['price']; ?>" />
                                                                    </td>
                                                                </tr>

                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                    <td><input type="hidden" name="id" id="id" value="<?php echo $id; ?>" /><input type="hidden" name="catID" id="catID" value="<?php echo $catID; ?>" /></td>
                                                                </tr>
                                                                <tr>
