                                    ...
                                    <tr height="480">
                                        ...
                                        <td valign="top">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td height="25" colspan="4" bgcolor="#F0F8FF" class="Heading6">Edit Testimonial</td>
                                                </tr>
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td colspan="4" valign="top"><form action="productUpdated.php" method="post" name="form1" id="form1">

                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td width="22%" align="left" class="text7">Name</td>
                                                                    <td width="78%" colspan="5"><label for="namee"></label>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="5" align="left"><label for="desc1"></label>
