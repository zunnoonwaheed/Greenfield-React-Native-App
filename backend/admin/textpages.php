                                            ...
                                            <table width="100%" border="0">
                                                <tr>
                                                    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td height="30" colspan="2" bgcolor="#F0F8FF" class="Heading6">Manage Newsletter</td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            if ($tp_id!="")
                                                            {
                                                                ...
                                                                $query = "select * from newsletter where id={$tp_id}";
                                                                //echo $query;
                                                                $result = mysqli_query($con,$query); 
                                                                $row = mysqli_fetch_array($result);
                                                                ?>
                                                                <tr>
                                                                    <td width="75%" class="Heading4"><span class="text6"><?php echo $row['pageData'];?></span></td>
                                                                    <td bgcolor="#EEF7FB"><a href="edit_tp1.php?pageID=<?php echo $tp_id; ?>">Edit Data</a></td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="2">&nbsp;</td>
                                                                </tr>
