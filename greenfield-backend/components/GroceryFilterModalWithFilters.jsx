...
const GroceryFilterModalWithFilters = ({ visible, onClose, onApplyFilters }) => {
  const [filters, setFilters] = useState({
    priceRange: '300',
    sortBy: 'Price (Low to High / High to Low)',
    discount: 'Show items on discount',
    rating: '4★ & above',
  ...
  const [selectedBrands, setSelectedBrands] = useState(['Alyas Farms', 'Anees Farms']);

  const FilterSection = ({ title, placeholder, icon, value, onPress, showBrands = false }) => (
    <View style={styles.filterSection}>
      ...
      <TouchableOpacity style={styles.filterInput} onPress={onPress}>
        ...
        {!showBrands && <DropdownIcon />}
      </TouchableOpacity>
      {showBrands && selectedBrands.length > 0 && (
  ...
  const RemoveIcon = () => (
    <Svg width={8} height={8} viewBox="0 0 8 8" fill="none">
      <Path
        d="M4.70449 3.99957L7.85221 0.856516C7.94629 0.762423 7.99915 0.634804 7.99915 0.501736C7.99915 0.368667 7.94629 0.241049 7.85221 0.146955C7.75812 0.0528613 7.63052 0 7.49747 0C7.36441 0 7.23681 0.0528613 7.14272 0.146955L4 3.29501L0.857278 0.146955C0.763194 0.0528613 0.635589 1.18144e-07 0.502535 1.19136e-07C0.369481 1.20127e-07 0.241876 0.0528613 0.147792 0.146955C0.0537084 0.241049 0.000852802 0.368667 0.000852801 0.501736C0.0008528 0.634804 0.0537084 0.762423 0.147792 0.856516L3.29551 3.99957L0.147792 7.14263C0.100962 7.18908 0.0637917 7.24435 0.0384257 7.30524C0.0130598 7.36613 0 7.43145 0 7.49741C0 7.56338 0.0130598 7.62869 0.0384257 7.68958C0.0637917 7.75047 0.100962 7.80574 0.147792 7.85219C0.19424 7.89903 0.2495 7.9362 0.310386 7.96157C0.371271 7.98694 0.436577 8 0.502535 8C0.568493 8 0.633799 7.98694 0.694684 7.96157C0.75557 7.9362 0.81083 7.89903 0.857278 7.85219L4 4.70414L7.14272 7.85219C7.18917 7.89903 7.24443 7.9362 7.30532 7.96157C7.3662 7.98694 7.43151 8 7.49747 8C7.56342 8 7.62873 7.98694 7.68961 7.96157C7.7505 7.9362 7.80576 7.89903 7.85221 7.85219C7.89904 7.80574 7.93621 7.75047 7.96158 7.68958C7.98694 7.62869 8 7.56338 8 7.49741C8 7.43145 7.98694 7.36613 7.96158 7.30524C7.93621 7.24435 7.89904 7.18908 7.85221 7.14263L4.70449 3.99957Z"
        fill="#009D66"
      />
    </Svg>
  );
...
export default GroceryFilterModalWithFilters;
